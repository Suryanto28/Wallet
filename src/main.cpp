...
#if defined(NDEBUG)
#error "TRBO cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in utrbo) are considered zero fee (for relaying and mining)
