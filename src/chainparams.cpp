...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1561879538, // * UNIX timestamp of last checkpoint block
    20000,     // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        strMasternodePoolDummyAddress = "TTuXaT4YMB8exQeyk9khGy2nLLunvEgsLn";
        nStartMasternodePayments = 1559757600; // Wednesday, 5 June 2019 18:00:00
