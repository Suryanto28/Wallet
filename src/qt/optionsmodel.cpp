...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::TRBO);
    ...
    if (!settings.contains("fShowMasternodesTab"))
        ...
        settings.setValue("fShowBudgetProposalsTab", false);     /*  default: false */
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in trbo.cpp during shotdown to also remove the window positions
