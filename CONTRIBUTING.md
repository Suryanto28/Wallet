Contributing to TRBO Core
==================================

The TRBO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TRBO Core project, and is not to be
confused with overall TRBO Network Protocol consensus changes.

Whether a pull request is merged into TRBO Core rests with the project merge
...
Patches that change TRBO consensus rules are considerably more involved than
...
Where a patch set proposes to change the TRBO consensus, it must have been
...
The project leader is the release manager for each TRBO Core release.
