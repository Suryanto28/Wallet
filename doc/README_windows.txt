...
Intro
-----
TRBO (TRBO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. TRBO utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run trbo-qt.exe.

TRBO Core is the original TRBO client and it builds the backbone of the network.
However, it downloads and stores the entire history of TRBO transactions;
