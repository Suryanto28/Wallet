...
This mechanism has been integrated into Bitcore-Node-TRBO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TRBO-Coin/Wallet/insight-api-trbo#web-socket-api](https://github.com/TRBO-Coin/Wallet/insight-api-trbo#web-socket-api)
* API: [https://github.com/TRBO-Coin/Wallet/insight-api-trbo#swifttx-transactions](https://github.com/TRBO-Coin/Wallet/insight-api-trbo#swifttx-transactions)
...
By default, the TRBO Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TRBO Core daemon:
