...
In order to support loading of multiple wallets in trbo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trbo.cpp.
...
Changes to trbo.cpp
----------------------
trbo.cpp is the entry point into trbo-qt, and as such, will require some minor modifications to provide hooks for
