...
RESOURCES += src/qt/trbo.qrc src/qt/trbo_locale.qrc

TRANSLATIONS += src/qt/locale/trbo_bg.ts \
                src/qt/locale/trbo_de.ts \
                src/qt/locale/trbo_en.ts \
                src/qt/locale/trbo_es.ts \
                src/qt/locale/trbo_fi.ts \
                src/qt/locale/trbo_fr.ts \
                src/qt/locale/trbo_it.ts \
                src/qt/locale/trbo_ja.ts \
                src/qt/locale/trbo_pl.ts \
                src/qt/locale/trbo_pt.ts \
                src/qt/locale/trbo_ru.ts \
                src/qt/locale/trbo_sk.ts \
                src/qt/locale/trbo_sv.ts \
                src/qt/locale/trbo_vi.ts \
                src/qt/locale/trbo_zh_CN.ts \
                src/qt/locale/trbo_zh_TW.ts
